...
<style lang='scss'>
  .survey-detail {
    ...
    .ans input[type="radio"].ans2+label::before,
    .ans input[type="checkbox"].ans2+label::before {
      content: "B";
    }
    .ans input[type="radio"].ans3+label::before,
    .ans input[type="checkbox"].ans3+label::before {
      content: "C";
    }
    .ans input[type="radio"].ans4+label::before,
    .ans input[type="checkbox"].ans4+label::before {
      content: "D";
    }
    .ans input[type="radio"]:checked+label::before,
    .ans input[type="checkbox"]:checked+label::before {
      background: #05a5f1;
    }
